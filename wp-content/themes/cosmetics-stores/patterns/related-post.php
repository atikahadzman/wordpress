...
/**
 * Title: Related Post
 * Slug: cosmetics-stores/related-post
 * Categories: cosmetics-stores, related-post
 */
?>
...
<h4 class="wp-block-heading has-text-align-left"><strong><?php esc_html_e('Related Posts :-','cosmetics-stores'); ?></strong></h4>
<!-- /wp:heading -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"10px","bottom":"10px","left":"10px","right":"10px"}},"color":{"background":"#ffffff"}},"layout":{"type":"default"}} -->
<div class="wp-block-group has-background" style="background-color:#ffffff;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px"><!-- wp:post-featured-image {"style":{"border":{"radius":"10px"}}} /-->
